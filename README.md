...
| Metric                        | AUC    | Accuracy | Sensitivity (Recall) | Specificity | F1-Score |
|-------------------------------|--------|----------|----------------------|-------------|----------|
| **Abnormal**                  | 0.9334 | 0.8500   | 0.9789               | 0.3600      | 0.9118   |
| **ACL**                       | 0.9442 | 0.8167   | 0.6667               | 0.9394      | 0.7660   |
| **Meniscus**                  | 0.8227 | 0.7250   | 0.7115               | 0.7353      | 0.6916   |
